...
const FamilyView: React.FC<FamilyViewProps> = ({ childrenList, onViewChild, onAddChild }) => {
    ...
    >
      ...
      <div className="flex flex-col items-center text-center relative z-10">
        ...
        <div className="w-full grid grid-cols-2 gap-3">
          <button className="flex items-center justify-center gap-2 py-3 bg-gray-50 dark:bg-background-dark rounded-2xl text-xs font-bold hover:bg-gray-100 transition-colors">
